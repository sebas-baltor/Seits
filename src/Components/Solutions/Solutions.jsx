...
export default function Solutions() {
    ...
    return (
        <section id="solutions" className="min-h-screen relative overflow-hidden px-12 py-40">
            ...
            <div className="absolute z-[-1] bottom-0 left-0 -translate-x-1/2 w-[50vw] h-[50vw] rounded-full bg-gray-950 blur-3xl"></div>
